                ...
                <div className="container">
                    <div className="row align-items-end">
                        <div className="col-lg-8 mb-30">
                            <h2 className="heading-2 mb-10">Últimas Noticias de la Ruta 8K</h2>
                            <p className="text-lg neutral-700">Prepárate para vivir una experiencia única entre mandarinas, comunidad y deporte.</p>
                        </div>
